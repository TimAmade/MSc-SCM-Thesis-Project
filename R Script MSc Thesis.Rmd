...
RestaurantData = RestaurantData %>% mutate(days_since_last_visit = ifelse(days_since_last_visit == 0,NA, days_since_last_visit)) #remove values for first time visits, as they are not meaningful
...
a.1 = mean(Sample$days_till_next_visit[Sample$num_past_visits >= 1 & Sample$Status == 0]) #mean: days
a.2 = mean(Sample$days_till_next_visit[Sample$num_past_visits == 0 & Sample$Status == 0]) #mean: days 
...
b.1 = mean(Sample$days_till_next_visit[Sample$num_cancellations == 0 & Sample$Status == 0]) #mean: days
b.2 = mean(Sample$days_till_next_visit[Sample$num_cancellations >= 1 & Sample$Status == 0]) #mean: days 
...
c.1 = mean(Sample$days_till_next_visit[Sample$days_since_last_visit < 30 & Sample$Status == 0]) #mean: days 
c.2 = mean(Sample$days_till_next_visit[Sample$days_since_last_visit > 29 & Sample$Status == 0]) #mean: days
...
mean(Sample$days_till_next_visit[Sample$num_cancellations == 0 & Sample$num_past_visits >= 1 & Sample$days_since_last_visit < 30]) #mean: days

mean(Sample$days_till_next_visit[Sample$num_cancellations >= 1 & Sample$num_past_visits == 0 & Sample$days_since_last_visit > 29]) #mean: days
```
